...
def login_required(f):
    ...
    def decorated_function(*args, **kwargs):
        if "logged_in" in session:
            ...
            flash("To view this page, please login.","danger")
...
def login():
    ...
    if request.method == "POST":
        ...
        if result > 0:
            ...
            flash("There is no such user registered with that username","danger")
            return redirect(url_for("login"))
...
def update(id):
    if request.method == "GET":
        ...
        if result == 0:
            flash("Either there is no such article or you don't have the permission to execute this action.","danger")
            return redirect(url_for("index"))
...
def search():
    if request.method == "GET":
        ...
        if result == 0:
            flash ("There is no suitable article for the word you are looking for","warning")
